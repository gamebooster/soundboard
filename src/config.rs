...
pub enum Key {
    ...
    KEY_1 = hotkey::keys::KEY_1 as isize,
    KEY_2 = hotkey::keys::KEY_2 as isize,
    KEY_3 = hotkey::keys::KEY_3 as isize,
    KEY_4 = hotkey::keys::KEY_4 as isize,
    KEY_5 = hotkey::keys::KEY_5 as isize,
    KEY_6 = hotkey::keys::KEY_6 as isize,
    KEY_7 = hotkey::keys::KEY_7 as isize,
    KEY_8 = hotkey::keys::KEY_8 as isize,
    KEY_9 = hotkey::keys::KEY_9 as isize,
    A = hotkey::keys::A as isize,
    B = hotkey::keys::B as isize,
    C = hotkey::keys::C as isize,
    D = hotkey::keys::D as isize,
    E = hotkey::keys::E as isize,
    F = hotkey::keys::F as isize,
    G = hotkey::keys::G as isize,
    H = hotkey::keys::H as isize,
    I = hotkey::keys::I as isize,
    J = hotkey::keys::J as isize,
    K = hotkey::keys::K as isize,
    L = hotkey::keys::L as isize,
    M = hotkey::keys::M as isize,
    N = hotkey::keys::N as isize,
    O = hotkey::keys::O as isize,
    P = hotkey::keys::P as isize,
    Q = hotkey::keys::Q as isize,
    R = hotkey::keys::R as isize,
    S = hotkey::keys::S as isize,
    T = hotkey::keys::T as isize,
    V = hotkey::keys::V as isize,
    X = hotkey::keys::X as isize,
    Y = hotkey::keys::Y as isize,
    Z = hotkey::keys::Z as isize,
}
